...
describe('search', () => {
    ...
    it('should retrieve the package url', () => {
        const pkg = 'foobar';
        expect(search.getSearchUrl(pkg)).toEqual(
            'https://npmsearch.com/query?q=foobar%20AND%20(keywords:dext-theme%20OR%20keywords:dext-plugin)&fields=name,description'
        );
    });
});
